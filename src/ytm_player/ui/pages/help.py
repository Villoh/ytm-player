...
ACTION_DESCRIPTIONS: dict[Action, str] = {
    ...
    Action.FOCUS_NEXT: "Focus next widget within current context (Tab)",
    Action.FOCUS_PREV: "Focus previous widget within current context (Shift+Tab)",
    Action.PANEL_LEFT: "Move focus to left panel (sidebar)",
    Action.PANEL_RIGHT: "Move focus to right panel (main content)",
    Action.PREV_TAB: "Go to previous tab (Browse)",
    Action.NEXT_TAB: "Go to next tab (Browse)",
    ...
    Action.CLEAR_QUEUE: "Clear the entire play queue",
